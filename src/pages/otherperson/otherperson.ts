...
/**
 * Generated class for the OtherpersonPage page.
 *
...
@Component({
  selector: 'page-otherperson',
  templateUrl: 'otherperson.html',
})
export class OtherpersonPage {
  fileElem: any;
  formElem: any;
  photos: any = [];  
  lifePhotos: any = [];
  ...
  editPerson(){
    ...
    this.cp.getData("user_profile/edit",{
      ...
      if(res.code = "0"){
        ...
        this.cp.u.user_profile.photo = this.stylephotos;
        ...
        console.log(this.cp.u,'这是修改的个人信息')
    })
  ...
  ionViewDidLoad() {
    ...
    this.stylephotos = this.cp.u.user_profile.photo;
